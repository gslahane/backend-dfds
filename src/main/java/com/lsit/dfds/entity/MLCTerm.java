// src/main/java/com/lsit/dfds/entity/MLCTerm.java
...
@Data
@Entity
@Table(name = "lsit_dfds_mlc_term", uniqueConstraints = @UniqueConstraint(columnNames = { "mlc_id", "start_fy_id",
		"end_fy_id" }))
public class MLCTerm {
